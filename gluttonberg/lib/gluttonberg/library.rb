...
module Gluttonberg
  module Library
    ...
    BINARY_CATEGORY = 'binary'
    CATEGORIES = [AUDIO_CATEGORY, IMAGE_CATEGORY, VIDEO_CATEGORY, DOCUMENT_CATEGORY, ARCHIVE_CATEGORY, BINARY_CATEGORY, UNCATEGORISED_CATEGORY]
